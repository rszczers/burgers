...
Zaczniemy od przypomnienia podstawowych pojęć w teorii rozmaitości gładkich. Pisząc o rozmaitościach i nie czyniąc żadnych dodatkowych wyróżnień będziemy mięli na względzie zawsze rozmaitości topologiczne klasy \(\mathrm{C}^{\infty}\).
